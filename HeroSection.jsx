    ...
    <section className="relative min-h-screen bg-secondary overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 pt-16 pb-24 flex flex-col items-center text-center">
        ...
        <motion.div
          ...
          className="mx-auto mt-8 rounded-2xl overflow-hidden shadow-2xl"
          style={{ width: "min(500px, 92vw)", aspectRatio: "4/3" }}
        >
          <img
            src="/images/card-semi-private.jpg"
            alt="Marco Polo Aquatics swim lessons"
